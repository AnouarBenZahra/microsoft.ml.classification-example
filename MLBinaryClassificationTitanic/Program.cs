...
namespace MLBinaryClassificationTitanic
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var predictionFunction = model.MakePredictionFunction<TitanicData, PredictionTitanic>(context);

            var prediction = predictionFunction.Predict(new TitanicData { Age = 30 });
